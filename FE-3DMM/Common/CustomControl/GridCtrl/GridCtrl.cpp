...
void CGridCtrl::OnHScroll(UINT nSBCode, UINT /*nPos*/, CScrollBar* /*pScrollBar*/)
{
    ...
    case SB_PAGERIGHT:
        if (scrollPos < m_nHScrollMax)
        {
            ...
            int pos = _MiN(m_nHScrollMax, scrollPos + offset);
...
void CGridCtrl::OnVScroll(UINT nSBCode, UINT /*nPos*/, CScrollBar* /*pScrollBar*/)
{
    ...
    case SB_PAGEDOWN:
        ...
        {
            rect.top = GetFixedRowHeight();
            scrollPos = _MiN(m_nVScrollMax, scrollPos + rect.Height());
                              ...
                              BOOL bForceRedraw /*=FALSE*/, BOOL bSelectCells /*=TRUE*/)
{
    ...
    if (GetSingleColSelection())
        ...
        SetSelectedRange(GetFixedRowCount(),
                         _MiN(m_SelectionStartCell.col, currentCell.col),
                         GetRowCount()-1,
                         _MaX(m_SelectionStartCell.col, currentCell.col),
                         bForceRedraw, bSelectCells);
}
                           ...
                           BOOL bForceRedraw /*=FALSE*/, BOOL bSelectCells /*=TRUE*/)
{
    ...
    if (GetSingleRowSelection())
        ...
        SetSelectedRange(_MiN(m_SelectionStartCell.row, currentCell.row),
                         Left,
                            ...
                            BOOL bForceRedraw /*=FALSE*/, BOOL bSelectCells /*=TRUE*/)
{
    ...
    SetSelectedRange(_MiN(m_SelectionStartCell.row, row),
                     _MiN(m_SelectionStartCell.col, col),
                                                  ...
                                                  BOOL bForceRecalculation /*=FALSE*/)
{
    ...
    int maxVisibleRow = _MiN(i, GetRowCount() - 1);
    ...
    int maxVisibleCol = _MiN(i, GetColumnCount() - 1);
    if (pRect)
    {
...
CCellRange CGridCtrl::GetSelectedCellRange() const
{
    ...
    for (POSITION pos = m_SelectedCellMap.GetStartPosition(); pos != NULL; )
    {
        ...
        Selection.SetMinRow( _MiN(Selection.GetMinRow(), cell.row) );
        Selection.SetMinCol( _MiN(Selection.GetMinCol(), cell.col) );
