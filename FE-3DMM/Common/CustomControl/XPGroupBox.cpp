...
void CXPGroupBox::SetGBStyle()
{
	SetXPGroupStyle(CXPGroupBox::XPGB_WINDOW);
	SetFontBold(TRUE);
	SetFontSize(18);
	SetAlignment(SS_LEFT);
}
//////////////////////////////////////////////////////////////////////////
//
// Function:		CXPGroupBox::~CXPGroupBox
...
void CXPGroupBox::OnPaint() 
{
	...
	dc.BitBlt(rect.left, rect.top, rect.Width(), rect.Height(),
		&dcMem, 0, 0, SRCCOPY);
	//dc.BitBlt(0,0,rect.Width(),rect.Height(),&dcMem,rect.Width(),rect.Height(),SRCCOPY);
...
CXPGroupBox& CXPGroupBox::SetFontSize(int nSize)
{
	...
	strcpy(m_lf.lfFaceName, "楷体_GB2312");  //字体设置
