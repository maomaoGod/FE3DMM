    ...
    BEGIN \
        ...
        BEGIN \
            ...
            BEGIN \
                ...
                VALUE "LegalCopyright", "Copyright (c) 2006-2015 Basler AG - All rights reserved.\0" \
                VALUE "LegalTrademarks", "\0" \
                VALUE "OLESelfRegister", "\0" \
                VALUE "OriginalFilename", PYLON_ORIGINAL_FILENAME(name) \
                VALUE "PrivateBuild", "\0" \
                VALUE "ProductName", "Basler pylon\0" \
                VALUE "ProductVersion", PYLON_VERSIONSTRING_MAJOR "." PYLON_VERSIONSTRING_MINOR "." PYLON_VERSIONSTRING_SUBMINOR "." PYLON_VERSIONSTRING_BUILD PYLON_VERSIONSTRING_SUFFIX PYLON_DEBUGSTRING "\0" \
