...
namespace Basler_GigECamera
{
    ...
    */
    GenApi::IEnumerationT<SequenceConfigurationModeEnums > &SequenceConfigurationMode;
...
This allows you undoing the latest unwanted changes of the color adjustment settings and returning to the preceding settings.
    ...
    */
    GenApi::IFloat &ScalingHorizontalAbs;
    ...
    */
    GenApi::IFloat &ScalingVerticalAbs;
...
Note: The maximum number of triggers within a burst sequence is limited. If the maximum number is exceeded, images may be damaged or lost.
    ...
    */
    GenApi::IBoolean &SyncFreeRunTimerEnable;
    ...
    */
    GenApi::IInteger &SyncFreeRunTimerStartTimeLow;
    ...
    */
    GenApi::IInteger &SyncFreeRunTimerStartTimeHigh;
    ...
    */
    GenApi::IFloat &SyncFreeRunTimerTriggerRateAbs;
    ...
    */
    GenApi::ICommand &SyncFreeRunTimerUpdate;
    ...
    */
    GenApi::IBoolean &GevSupportedOptionalLegacy16BitBlockID;
    ...
    */
    GenApi::IBoolean &GevSupportedIEEE1588;
    ...
    */
    GenApi::IInteger &GevIEEE1588OffsetFromMaster;
    ...
    */
    GenApi::IInteger &GevIEEE1588ClockIdLow;
    ...
    */
    GenApi::IInteger &GevIEEE1588ClockIdHigh;
    ...
    */
    GenApi::IInteger &GevIEEE1588ParentClockIdLow;
    ...
    */
    GenApi::IInteger &GevIEEE1588ParentClockIdHigh;
    ...
    */
    GenApi::IInteger &GevIEEE1588ParentClockId;
    ...
    */
    GenApi::IInteger &GevPTPDiagnosticsQueueRxEvntMaxNumElements;
    ...
    */
    GenApi::IInteger &GevPTPDiagnosticsQueueRxGnrlMaxNumElements;
    ...
    */
    GenApi::IInteger &GevPTPDiagnosticsQueueRxEvntPushNumFailure;
    ...
    */
    GenApi::IInteger &GevPTPDiagnosticsQueueRxGnrlPushNumFailure;
    ...
    */
    GenApi::IInteger &GevPTPDiagnosticsQueueSendNumFailure;
    ...
    */
    GenApi::IInteger &LateActionEventStreamChannelIndex;
    ...
    */
    GenApi::IInteger &LateActionEventTimestamp;
    ...
    */
    GenApi::IInteger &FrameWaitEventStreamChannelIndex;
    ...
    */
    GenApi::IInteger &FrameWaitEventTimestamp;
    ...
    */
    GenApi::IInteger &AcquisitionWaitEventStreamChannelIndex;
    ...
    */
    GenApi::IInteger &AcquisitionWaitEventTimestamp;
    ...
    */
    ...
    inline CGigECamera_Params::CGigECamera_Params(void)
        ...
        , SequenceConfigurationMode( *new GenApi::CEnumerationTRef<SequenceConfigurationModeEnums>() )
        ...
        , ScalingHorizontalAbs( *new GenApi::CFloatRef() )
        , ScalingVerticalAbs( *new GenApi::CFloatRef() )
        ...
        , SyncFreeRunTimerEnable( *new GenApi::CBooleanRef() )
        , SyncFreeRunTimerStartTimeLow( *new GenApi::CIntegerRef() )
        , SyncFreeRunTimerStartTimeHigh( *new GenApi::CIntegerRef() )
        , SyncFreeRunTimerTriggerRateAbs( *new GenApi::CFloatRef() )
        , SyncFreeRunTimerUpdate( *new GenApi::CCommandRef() )
        ...
        , GevGVSPExtendedIDMode( *new GenApi::CEnumerationTRef<GevGVSPExtendedIDModeEnums>() )
        ...
        , GevSupportedOptionalLegacy16BitBlockID( *new GenApi::CBooleanRef() )
        , GevSupportedIEEE1588( *new GenApi::CBooleanRef() )
        ...
        , GevIEEE1588( *new GenApi::CBooleanRef() )
        , GevIEEE1588Status( *new GenApi::CEnumerationTRef<GevIEEE1588StatusEnums>() )
        , GevIEEE1588DataSetLatch( *new GenApi::CCommandRef() )
        , GevIEEE1588StatusLatched( *new GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums>() )
        , GevIEEE1588OffsetFromMaster( *new GenApi::CIntegerRef() )
        , GevIEEE1588ClockIdLow( *new GenApi::CIntegerRef() )
        , GevIEEE1588ClockIdHigh( *new GenApi::CIntegerRef() )
        , GevIEEE1588ClockId( *new GenApi::CIntegerRef() )
        , GevIEEE1588ParentClockIdLow( *new GenApi::CIntegerRef() )
        , GevIEEE1588ParentClockIdHigh( *new GenApi::CIntegerRef() )
        , GevIEEE1588ParentClockId( *new GenApi::CIntegerRef() )
        , GevPTPDiagnosticsQueueRxEvntMaxNumElements( *new GenApi::CIntegerRef() )
        , GevPTPDiagnosticsQueueRxGnrlMaxNumElements( *new GenApi::CIntegerRef() )
        , GevPTPDiagnosticsQueueRxEvntPushNumFailure( *new GenApi::CIntegerRef() )
        , GevPTPDiagnosticsQueueRxGnrlPushNumFailure( *new GenApi::CIntegerRef() )
        , GevPTPDiagnosticsQueueSendNumFailure( *new GenApi::CIntegerRef() )
        ...
        , ActionSelector( *new GenApi::CIntegerRef() )
        , ActionDeviceKey( *new GenApi::CIntegerRef() )
        , ActionCommandCount( *new GenApi::CIntegerRef() )
        , ActionGroupKey( *new GenApi::CIntegerRef() )
        , ActionGroupMask( *new GenApi::CIntegerRef() )
        ...
        , ChunkVirtLineStatusAll( *new GenApi::CIntegerRef() )
        ...
        , ChunkGainAll( *new GenApi::CIntegerRef() )
        , ChunkLineTriggerCounter( *new GenApi::CIntegerRef() )
        ...
        , LateActionEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , LateActionEventTimestamp( *new GenApi::CIntegerRef() )
        , Line1RisingEdgeEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , Line1RisingEdgeEventTimestamp( *new GenApi::CIntegerRef() )
        , Line2RisingEdgeEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , Line2RisingEdgeEventTimestamp( *new GenApi::CIntegerRef() )
        , Line3RisingEdgeEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , Line3RisingEdgeEventTimestamp( *new GenApi::CIntegerRef() )
        , Line4RisingEdgeEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , Line4RisingEdgeEventTimestamp( *new GenApi::CIntegerRef() )
        , VirtualLine1RisingEdgeEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , VirtualLine1RisingEdgeEventTimestamp( *new GenApi::CIntegerRef() )
        , VirtualLine2RisingEdgeEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , VirtualLine2RisingEdgeEventTimestamp( *new GenApi::CIntegerRef() )
        , VirtualLine3RisingEdgeEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , VirtualLine3RisingEdgeEventTimestamp( *new GenApi::CIntegerRef() )
        , VirtualLine4RisingEdgeEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , VirtualLine4RisingEdgeEventTimestamp( *new GenApi::CIntegerRef() )
        , FrameWaitEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , FrameWaitEventTimestamp( *new GenApi::CIntegerRef() )
        , AcquisitionWaitEventStreamChannelIndex( *new GenApi::CIntegerRef() )
        , AcquisitionWaitEventTimestamp( *new GenApi::CIntegerRef() )
    ...
    inline CGigECamera_Params::~CGigECamera_Params(void)
    {
        ...
        delete static_cast < GenApi::CEnumerationTRef<SequenceConfigurationModeEnums> *> (&SequenceConfigurationMode );
        ...
        delete static_cast < GenApi::CFloatRef*> (&ScalingHorizontalAbs );
        delete static_cast < GenApi::CFloatRef*> (&ScalingVerticalAbs );
        ...
        delete static_cast < GenApi::CBooleanRef*> (&SyncFreeRunTimerEnable );
        delete static_cast < GenApi::CIntegerRef*> (&SyncFreeRunTimerStartTimeLow );
        delete static_cast < GenApi::CIntegerRef*> (&SyncFreeRunTimerStartTimeHigh );
        delete static_cast < GenApi::CFloatRef*> (&SyncFreeRunTimerTriggerRateAbs );
        delete static_cast < GenApi::CCommandRef*> (&SyncFreeRunTimerUpdate );
        ...
        delete static_cast < GenApi::CEnumerationTRef<GevGVSPExtendedIDModeEnums> *> (&GevGVSPExtendedIDMode );
        ...
        delete static_cast < GenApi::CBooleanRef*> (&GevSupportedOptionalLegacy16BitBlockID );
        delete static_cast < GenApi::CBooleanRef*> (&GevSupportedIEEE1588 );
        ...
        delete static_cast < GenApi::CBooleanRef*> (&GevIEEE1588 );
        delete static_cast < GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status );
        delete static_cast < GenApi::CCommandRef*> (&GevIEEE1588DataSetLatch );
        delete static_cast < GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched );
        delete static_cast < GenApi::CIntegerRef*> (&GevIEEE1588OffsetFromMaster );
        delete static_cast < GenApi::CIntegerRef*> (&GevIEEE1588ClockIdLow );
        delete static_cast < GenApi::CIntegerRef*> (&GevIEEE1588ClockIdHigh );
        delete static_cast < GenApi::CIntegerRef*> (&GevIEEE1588ClockId );
        delete static_cast < GenApi::CIntegerRef*> (&GevIEEE1588ParentClockIdLow );
        delete static_cast < GenApi::CIntegerRef*> (&GevIEEE1588ParentClockIdHigh );
        delete static_cast < GenApi::CIntegerRef*> (&GevIEEE1588ParentClockId );
        delete static_cast < GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueRxEvntMaxNumElements );
        delete static_cast < GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueRxGnrlMaxNumElements );
        delete static_cast < GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueRxEvntPushNumFailure );
        delete static_cast < GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueRxGnrlPushNumFailure );
        delete static_cast < GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueSendNumFailure );
        ...
        delete static_cast < GenApi::CIntegerRef*> (&ActionSelector );
        delete static_cast < GenApi::CIntegerRef*> (&ActionDeviceKey );
        delete static_cast < GenApi::CIntegerRef*> (&ActionCommandCount );
        delete static_cast < GenApi::CIntegerRef*> (&ActionGroupKey );
        delete static_cast < GenApi::CIntegerRef*> (&ActionGroupMask );
        ...
        delete static_cast < GenApi::CIntegerRef*> (&ChunkVirtLineStatusAll );
        ...
        delete static_cast < GenApi::CIntegerRef*> (&ChunkGainAll );
        delete static_cast < GenApi::CIntegerRef*> (&ChunkLineTriggerCounter );
        ...
        delete static_cast < GenApi::CIntegerRef*> (&LateActionEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&LateActionEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&Line1RisingEdgeEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&Line1RisingEdgeEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&Line2RisingEdgeEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&Line2RisingEdgeEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&Line3RisingEdgeEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&Line3RisingEdgeEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&Line4RisingEdgeEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&Line4RisingEdgeEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&VirtualLine1RisingEdgeEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&VirtualLine1RisingEdgeEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&VirtualLine2RisingEdgeEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&VirtualLine2RisingEdgeEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&VirtualLine3RisingEdgeEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&VirtualLine3RisingEdgeEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&VirtualLine4RisingEdgeEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&VirtualLine4RisingEdgeEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&FrameWaitEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&FrameWaitEventTimestamp );
        delete static_cast < GenApi::CIntegerRef*> (&AcquisitionWaitEventStreamChannelIndex );
        delete static_cast < GenApi::CIntegerRef*> (&AcquisitionWaitEventTimestamp );
    ...
    static_cast<GenApi::CEnumerationTRef<SequenceConfigurationModeEnums> *> (&SequenceConfigurationMode )->SetReference(_Ptr->GetNode("SequenceConfigurationMode"));
    static_cast<GenApi::CEnumerationTRef<SequenceConfigurationModeEnums> *> (&SequenceConfigurationMode )->SetNumEnums(2);
    static_cast<GenApi::CEnumerationTRef<SequenceConfigurationModeEnums> *> (&SequenceConfigurationMode )->SetEnumReference( SequenceConfigurationMode_Off, "Off" );        static_cast<GenApi::CEnumerationTRef<SequenceConfigurationModeEnums> *> (&SequenceConfigurationMode )->SetEnumReference( SequenceConfigurationMode_On, "On" );        static_cast<GenApi::CCommandRef*> (&SequenceAsyncRestart )->SetReference(_Ptr->GetNode("SequenceAsyncRestart"));
    ...
    static_cast<GenApi::CFloatRef*> (&ScalingHorizontalAbs )->SetReference(_Ptr->GetNode("ScalingHorizontalAbs"));
    static_cast<GenApi::CFloatRef*> (&ScalingVerticalAbs )->SetReference(_Ptr->GetNode("ScalingVerticalAbs"));
    ...
    static_cast<GenApi::CFloatRef*> (&ResultingFramePeriodAbs )->SetReference(_Ptr->GetNode("ResultingFramePeriodAbs"));
    ...
    static_cast<GenApi::CBooleanRef*> (&SyncFreeRunTimerEnable )->SetReference(_Ptr->GetNode("SyncFreeRunTimerEnable"));
    static_cast<GenApi::CIntegerRef*> (&SyncFreeRunTimerStartTimeLow )->SetReference(_Ptr->GetNode("SyncFreeRunTimerStartTimeLow"));
    static_cast<GenApi::CIntegerRef*> (&SyncFreeRunTimerStartTimeHigh )->SetReference(_Ptr->GetNode("SyncFreeRunTimerStartTimeHigh"));
    static_cast<GenApi::CFloatRef*> (&SyncFreeRunTimerTriggerRateAbs )->SetReference(_Ptr->GetNode("SyncFreeRunTimerTriggerRateAbs"));
    static_cast<GenApi::CCommandRef*> (&SyncFreeRunTimerUpdate )->SetReference(_Ptr->GetNode("SyncFreeRunTimerUpdate"));
    ...
    static_cast<GenApi::CEnumerationTRef<GevGVSPExtendedIDModeEnums> *> (&GevGVSPExtendedIDMode )->SetReference(_Ptr->GetNode("GevGVSPExtendedIDMode"));
    static_cast<GenApi::CEnumerationTRef<GevGVSPExtendedIDModeEnums> *> (&GevGVSPExtendedIDMode )->SetNumEnums(2);
    static_cast<GenApi::CEnumerationTRef<GevGVSPExtendedIDModeEnums> *> (&GevGVSPExtendedIDMode )->SetEnumReference( GevGVSPExtendedIDMode_Off, "Off" );        static_cast<GenApi::CEnumerationTRef<GevGVSPExtendedIDModeEnums> *> (&GevGVSPExtendedIDMode )->SetEnumReference( GevGVSPExtendedIDMode_On, "On" );        static_cast<GenApi::CBooleanRef*> (&GevSupportedIPConfigurationLLA )->SetReference(_Ptr->GetNode("GevSupportedIPConfigurationLLA"));
    ...
    static_cast<GenApi::CBooleanRef*> (&GevSupportedOptionalLegacy16BitBlockID )->SetReference(_Ptr->GetNode("GevSupportedOptionalLegacy16BitBlockID"));
    static_cast<GenApi::CBooleanRef*> (&GevSupportedIEEE1588 )->SetReference(_Ptr->GetNode("GevSupportedIEEE1588"));
    ...
    static_cast<GenApi::CBooleanRef*> (&GevIEEE1588 )->SetReference(_Ptr->GetNode("GevIEEE1588"));
    static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetReference(_Ptr->GetNode("GevIEEE1588Status"));
    static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetNumEnums(10);
    static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_Undefined, "Undefined" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_Initializing, "Initializing" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_Faulty, "Faulty" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_Disabled, "Disabled" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_Listening, "Listening" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_PreMaster, "PreMaster" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_Master, "Master" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_Passive, "Passive" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_Uncalibrated, "Uncalibrated" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusEnums> *> (&GevIEEE1588Status )->SetEnumReference( GevIEEE1588Status_Slave, "Slave" );        static_cast<GenApi::CCommandRef*> (&GevIEEE1588DataSetLatch )->SetReference(_Ptr->GetNode("GevIEEE1588DataSetLatch"));
    static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetReference(_Ptr->GetNode("GevIEEE1588StatusLatched"));
    static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetNumEnums(10);
    static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_Undefined, "Undefined" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_Initializing, "Initializing" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_Faulty, "Faulty" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_Disabled, "Disabled" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_Listening, "Listening" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_PreMaster, "PreMaster" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_Master, "Master" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_Passive, "Passive" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_Uncalibrated, "Uncalibrated" );        static_cast<GenApi::CEnumerationTRef<GevIEEE1588StatusLatchedEnums> *> (&GevIEEE1588StatusLatched )->SetEnumReference( GevIEEE1588StatusLatched_Slave, "Slave" );        static_cast<GenApi::CIntegerRef*> (&GevIEEE1588OffsetFromMaster )->SetReference(_Ptr->GetNode("GevIEEE1588OffsetFromMaster"));
    static_cast<GenApi::CIntegerRef*> (&GevIEEE1588ClockIdLow )->SetReference(_Ptr->GetNode("GevIEEE1588ClockIdLow"));
    static_cast<GenApi::CIntegerRef*> (&GevIEEE1588ClockIdHigh )->SetReference(_Ptr->GetNode("GevIEEE1588ClockIdHigh"));
    static_cast<GenApi::CIntegerRef*> (&GevIEEE1588ClockId )->SetReference(_Ptr->GetNode("GevIEEE1588ClockId"));
    static_cast<GenApi::CIntegerRef*> (&GevIEEE1588ParentClockIdLow )->SetReference(_Ptr->GetNode("GevIEEE1588ParentClockIdLow"));
    static_cast<GenApi::CIntegerRef*> (&GevIEEE1588ParentClockIdHigh )->SetReference(_Ptr->GetNode("GevIEEE1588ParentClockIdHigh"));
    static_cast<GenApi::CIntegerRef*> (&GevIEEE1588ParentClockId )->SetReference(_Ptr->GetNode("GevIEEE1588ParentClockId"));
    static_cast<GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueRxEvntMaxNumElements )->SetReference(_Ptr->GetNode("GevPTPDiagnosticsQueueRxEvntMaxNumElements"));
    static_cast<GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueRxGnrlMaxNumElements )->SetReference(_Ptr->GetNode("GevPTPDiagnosticsQueueRxGnrlMaxNumElements"));
    static_cast<GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueRxEvntPushNumFailure )->SetReference(_Ptr->GetNode("GevPTPDiagnosticsQueueRxEvntPushNumFailure"));
    static_cast<GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueRxGnrlPushNumFailure )->SetReference(_Ptr->GetNode("GevPTPDiagnosticsQueueRxGnrlPushNumFailure"));
    static_cast<GenApi::CIntegerRef*> (&GevPTPDiagnosticsQueueSendNumFailure )->SetReference(_Ptr->GetNode("GevPTPDiagnosticsQueueSendNumFailure"));
    ...
    static_cast<GenApi::CIntegerRef*> (&ActionSelector )->SetReference(_Ptr->GetNode("ActionSelector"));
    static_cast<GenApi::CIntegerRef*> (&ActionDeviceKey )->SetReference(_Ptr->GetNode("ActionDeviceKey"));
    static_cast<GenApi::CIntegerRef*> (&ActionCommandCount )->SetReference(_Ptr->GetNode("ActionCommandCount"));
    static_cast<GenApi::CIntegerRef*> (&ActionGroupKey )->SetReference(_Ptr->GetNode("ActionGroupKey"));
    static_cast<GenApi::CIntegerRef*> (&ActionGroupMask )->SetReference(_Ptr->GetNode("ActionGroupMask"));
    ...
    static_cast<GenApi::CEnumerationTRef<UserSetSelectorEnums> *> (&UserSetSelector )->SetNumEnums(10);
    ...
    static_cast<GenApi::CIntegerRef*> (&ChunkVirtLineStatusAll )->SetReference(_Ptr->GetNode("ChunkVirtLineStatusAll"));
    ...
    static_cast<GenApi::CIntegerRef*> (&ChunkGainAll )->SetReference(_Ptr->GetNode("ChunkGainAll"));
    static_cast<GenApi::CIntegerRef*> (&ChunkLineTriggerCounter )->SetReference(_Ptr->GetNode("ChunkLineTriggerCounter"));
    static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetReference(_Ptr->GetNode("EventSelector"));
    static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetNumEnums(21);
    static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_ExposureEnd, "ExposureEnd" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_LineStartOvertrigger, "LineStartOvertrigger" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_FrameStartOvertrigger, "FrameStartOvertrigger" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_AcquisitionStartOvertrigger, "AcquisitionStartOvertrigger" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_FrameTimeout, "FrameTimeout" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_FrameStart, "FrameStart" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_AcquisitionStart, "AcquisitionStart" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_CriticalTemperature, "CriticalTemperature" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_OverTemperature, "OverTemperature" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_ActionLate, "ActionLate" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_Line1RisingEdge, "Line1RisingEdge" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_Line2RisingEdge, "Line2RisingEdge" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_Line3RisingEdge, "Line3RisingEdge" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_Line4RisingEdge, "Line4RisingEdge" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_VirtualLine1RisingEdge, "VirtualLine1RisingEdge" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_VirtualLine2RisingEdge, "VirtualLine2RisingEdge" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_VirtualLine3RisingEdge, "VirtualLine3RisingEdge" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_VirtualLine4RisingEdge, "VirtualLine4RisingEdge" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_FrameWait, "FrameWait" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_AcquisitionWait, "AcquisitionWait" );        static_cast<GenApi::CEnumerationTRef<EventSelectorEnums> *> (&EventSelector )->SetEnumReference( EventSelector_EventOverrun, "EventOverrun" );        static_cast<GenApi::CEnumerationTRef<EventNotificationEnums> *> (&EventNotification )->SetReference(_Ptr->GetNode("EventNotification"));
    ...
    static_cast<GenApi::CIntegerRef*> (&LateActionEventStreamChannelIndex )->SetReference(_Ptr->GetNode("LateActionEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&LateActionEventTimestamp )->SetReference(_Ptr->GetNode("LateActionEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&Line1RisingEdgeEventStreamChannelIndex )->SetReference(_Ptr->GetNode("Line1RisingEdgeEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&Line1RisingEdgeEventTimestamp )->SetReference(_Ptr->GetNode("Line1RisingEdgeEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&Line2RisingEdgeEventStreamChannelIndex )->SetReference(_Ptr->GetNode("Line2RisingEdgeEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&Line2RisingEdgeEventTimestamp )->SetReference(_Ptr->GetNode("Line2RisingEdgeEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&Line3RisingEdgeEventStreamChannelIndex )->SetReference(_Ptr->GetNode("Line3RisingEdgeEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&Line3RisingEdgeEventTimestamp )->SetReference(_Ptr->GetNode("Line3RisingEdgeEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&Line4RisingEdgeEventStreamChannelIndex )->SetReference(_Ptr->GetNode("Line4RisingEdgeEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&Line4RisingEdgeEventTimestamp )->SetReference(_Ptr->GetNode("Line4RisingEdgeEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&VirtualLine1RisingEdgeEventStreamChannelIndex )->SetReference(_Ptr->GetNode("VirtualLine1RisingEdgeEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&VirtualLine1RisingEdgeEventTimestamp )->SetReference(_Ptr->GetNode("VirtualLine1RisingEdgeEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&VirtualLine2RisingEdgeEventStreamChannelIndex )->SetReference(_Ptr->GetNode("VirtualLine2RisingEdgeEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&VirtualLine2RisingEdgeEventTimestamp )->SetReference(_Ptr->GetNode("VirtualLine2RisingEdgeEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&VirtualLine3RisingEdgeEventStreamChannelIndex )->SetReference(_Ptr->GetNode("VirtualLine3RisingEdgeEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&VirtualLine3RisingEdgeEventTimestamp )->SetReference(_Ptr->GetNode("VirtualLine3RisingEdgeEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&VirtualLine4RisingEdgeEventStreamChannelIndex )->SetReference(_Ptr->GetNode("VirtualLine4RisingEdgeEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&VirtualLine4RisingEdgeEventTimestamp )->SetReference(_Ptr->GetNode("VirtualLine4RisingEdgeEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&FrameWaitEventStreamChannelIndex )->SetReference(_Ptr->GetNode("FrameWaitEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&FrameWaitEventTimestamp )->SetReference(_Ptr->GetNode("FrameWaitEventTimestamp"));
    static_cast<GenApi::CIntegerRef*> (&AcquisitionWaitEventStreamChannelIndex )->SetReference(_Ptr->GetNode("AcquisitionWaitEventStreamChannelIndex"));
    static_cast<GenApi::CIntegerRef*> (&AcquisitionWaitEventTimestamp )->SetReference(_Ptr->GetNode("AcquisitionWaitEventTimestamp"));
